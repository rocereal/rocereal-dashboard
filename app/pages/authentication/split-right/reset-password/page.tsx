/**
 * Split Right Reset Password Page Component
 * Authentication page for password reset completion with split-screen layout (form on right, carousel on left)
...
export default function ResetPasswordPage() {
   ...
   * @returns JSX element representing the split-right reset password page interface
   */
  if (isSubmitted) {
    return (
          ...
          <CardContent className="pt-6">
            ...
            <div className="mt-6">
              <Button className="w-full">
                <Link href="/split-right/login">Sign in with new password</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
