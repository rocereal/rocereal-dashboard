...
/**
 * RenderPage component for the first step of split-left onboarding
 * Client-side component that renders onboarding wizard sidebar and step one form content
