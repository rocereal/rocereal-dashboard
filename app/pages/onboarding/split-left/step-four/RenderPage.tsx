...
/**
 * RenderPage component for the final step of split-left onboarding
 * Client-side component that renders split-screen layout with completion form on left and wizard sidebar on right
