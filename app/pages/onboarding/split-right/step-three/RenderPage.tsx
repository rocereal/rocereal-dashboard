...
/**
 * RenderPage component for the third step of split-right onboarding
      ...
      <div className="p-8 space-y-8 w-full lg:w-1/2 justify-center items-center">
        ...
        <div className="flex flex-col space-y-4 max-w-xl mx-auto">
          ...
          <StepThree
            onSubmit={handleForm}
            isLoading={isLoading}
            onboardingHref="/pages/onboarding/split-right/step-four"
            skipHref="/pages/onboarding/split-right/step-four"
          />
        </div>
      </div>
      <OnboardingWizardSplit
        image={backgroundSeven}
        subtitle={onboardingSteps[2]?.subtitle}
