...
/**
 * RenderPage component for the first step of split-right onboarding
      ...
      <div className="p-8 space-y-8 w-full lg:w-1/2 justify-center items-center">
        ...
        <div className="flex flex-col space-y-4 max-w-xl mx-auto">
          ...
          <StepOne
            onSubmit={handleForm}
            isLoading={isLoading}
            onboardingHref="/pages/onboarding/split-right/step-two"
            skipHref="/pages/onboarding/split-right/step-two"
          />
        </div>
      </div>
